...
class TestGene(unittest.TestCase):
	...
	def test_full_coverage(self):
		...
		self.assertEqual(str(g), 'rep5.1	Full	100	NC005011	plasmidfinder	rep5.1_rep(pMW2)_NC005011')

	def test_no_coverage(self):
		g = Gene('rep5.1_rep(pMW2)_NC005011', 0, 10)
		self.assertFalse(g.is_full_coverage())
		self.assertEqual(str(g), 'rep5.1	Partial	0	NC005011	plasmidfinder	rep5.1_rep(pMW2)_NC005011')
		
	def test_medium_coverage(self):
		g = Gene('rep5.1_rep(pMW2)_NC005011', 5, 5)
		self.assertFalse(g.is_full_coverage())
		self.assertEqual(str(g), 'rep5.1	Partial	50	NC005011	plasmidfinder	rep5.1_rep(pMW2)_NC005011')
