 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_sequence)) || PyTuple_CheckExact(__pyx_v_sequence)) {
    ...
    __pyx_t_2 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_sequence); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    __pyx_t_4 = PyObject_RichCompare(__pyx_v_base, __pyx_v_previous_base, Py_NE); __Pyx_XGOTREF(__pyx_t_4); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyString_Join(__pyx_kp_s_, __pyx_v_compressed_sequence); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_compressed_sequence);
